...
})(window, function(__WEBPACK_EXTERNAL_MODULE__68__) {
...
/* harmony import */ var _xmldom_xmldom__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(27);
...
"use strict";
/* harmony import */ var core_js_modules_es_array_includes_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(45);
...
/* harmony import */ var _mapping__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(18);
/* harmony import */ var _utils_replacements__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(9);
/* harmony import */ var _utils_constants__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(1);
...
class Contents {
  constructor(doc, content, cfiBase, sectionIndex) {
    ...
    this.epubReadingSystem("epub.js", _utils_constants__WEBPACK_IMPORTED_MODULE_6__[/* EPUBJS_VERSION */ "b"]);
    this.called = 0;
    this.active = true;
    this.listeners();
  }
  ...
  static get listenedEvents() {
    return _utils_constants__WEBPACK_IMPORTED_MODULE_6__[/* DOM_EVENTS */ "a"];
  }
  /**
  	* Get or Set width
  	* @param {number} [w]
  ...
  width(w) {
    ...
    if (w && Object(_utils_core__WEBPACK_IMPORTED_MODULE_2__["isNumber"])(w)) {
      w = w + "px";
    }
  ...
  height(h) {
    ...
    if (h && Object(_utils_core__WEBPACK_IMPORTED_MODULE_2__["isNumber"])(h)) {
      h = h + "px";
    }
  ...
  textWidth() {
    ...
    let border = Object(_utils_core__WEBPACK_IMPORTED_MODULE_2__["borders"])(content); // Select the contents of frame
  ...
  viewport(options) {
    ...
    */
    ...
    settings = Object(_utils_core__WEBPACK_IMPORTED_MODULE_2__["defaults"])(options || {}, parsed);
  ...
  expand() {
    this.emit(_utils_constants__WEBPACK_IMPORTED_MODULE_6__[/* EVENTS */ "c"].CONTENTS.EXPAND);
  }
  /**
   * Add DOM listeners
   * @private
  ...
  resizeCheck() {
    ...
    if (width != this._size.width || height != this._size.height) {
      ...
      this.emit(_utils_constants__WEBPACK_IMPORTED_MODULE_6__[/* EVENTS */ "c"].CONTENTS.RESIZE, this._size);
    }
  }
  /**
  ...
  locationOf(target, ignoreClass) {
    ...
    if (this.epubcfi.isCfiString(target)) {
      let range = new _epubcfi__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"](target).toRange(this.document, ignoreClass);
  ...
  addEventListeners() {
    ...
    _utils_constants__WEBPACK_IMPORTED_MODULE_6__[/* DOM_EVENTS */ "a"].forEach(function (eventName) {
  ...
  triggerSelectedEvent(selection) {
    ...
    if (selection && selection.rangeCount > 0) {
      ...
      if (!range.collapsed) {
        ...
        cfirange = new _epubcfi__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"](range, this.cfiBase).toString();
        this.emit(_utils_constants__WEBPACK_IMPORTED_MODULE_6__[/* EVENTS */ "c"].CONTENTS.SELECTED, cfirange);
        this.emit(_utils_constants__WEBPACK_IMPORTED_MODULE_6__[/* EVENTS */ "c"].CONTENTS.SELECTED_RANGE, range);
      }
    }
  }
  /**
  ...
  range(_cfi, ignoreClass) {
    var cfi = new _epubcfi__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"](_cfi);
  ...
  cfiFromRange(range, ignoreClass) {
    return new _epubcfi__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"](range, this.cfiBase, ignoreClass).toString();
  }
  /**
  ...
  cfiFromNode(node, ignoreClass) {
    return new _epubcfi__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"](node, this.cfiBase, ignoreClass).toString();
  } // TODO: find where this is used - remove?


  map(layout) {
    var map = new _mapping__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"](layout);
    return map.section();
  }
  /**
  ...
  columns(width, height, columnWidth, gap, dir) {
    let COLUMN_AXIS = Object(_utils_core__WEBPACK_IMPORTED_MODULE_2__["prefixed"])("column-axis");
    let COLUMN_GAP = Object(_utils_core__WEBPACK_IMPORTED_MODULE_2__["prefixed"])("column-gap");
    let COLUMN_WIDTH = Object(_utils_core__WEBPACK_IMPORTED_MODULE_2__["prefixed"])("column-width");
    let COLUMN_FILL = Object(_utils_core__WEBPACK_IMPORTED_MODULE_2__["prefixed"])("column-fill");
  ...
  mapPage(cfiBase, layout, start, end, dev) {
    var mapping = new _mapping__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"](layout, dev);
  ...
  linksHandler() {
    Object(_utils_replacements__WEBPACK_IMPORTED_MODULE_5__[/* replaceLinks */ "c"])(this.content, href => {
      this.emit(_utils_constants__WEBPACK_IMPORTED_MODULE_6__[/* EVENTS */ "c"].CONTENTS.LINK_CLICKED, href);
    });
  }
  /**
  ...
  writingMode(mode) {
    let WRITING_MODE = Object(_utils_core__WEBPACK_IMPORTED_MODULE_2__["prefixed"])("writing-mode");
...
event_emitter__WEBPACK_IMPORTED_MODULE_1___default()(Contents.prototype);
...
exports.DOMParser = __webpack_require__(88).DOMParser
...
var src_contents = __webpack_require__(15);
...
// EXTERNAL MODULE: ./src/managers/views/inline.js
var inline = __webpack_require__(38);

// EXTERNAL MODULE: ./src/managers/default/index.js + 3 modules
var managers_default = __webpack_require__(17);

// EXTERNAL MODULE: ./src/managers/continuous/index.js + 1 modules
var continuous = __webpack_require__(40);
...
/* harmony import */ var _contents__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(15);
/* harmony import */ var _utils_constants__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(1);
/* harmony import */ var marks_pane__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(21);
...
class InlineView {
  ...
  lock(what, width, height) {
    ...
    if (this.frame) {
      iframeBorders = Object(_utils_core__WEBPACK_IMPORTED_MODULE_1__["borders"])(this.frame);
    } else {
      iframeBorders = {
        width: 0,
        height: 0
  ...
  load(contents) {
    var loading = new _utils_core__WEBPACK_IMPORTED_MODULE_1__["defer"]();
    var loaded = loading.promise;
    var doc = Object(_utils_core__WEBPACK_IMPORTED_MODULE_1__["parse"])(contents, "text/html");
    ...
    */
    ...
    this.window = this.document.defaultView;
    this.contents = new _contents__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"](this.document, this.frame);
    this.rendering = false;
...
event_emitter__WEBPACK_IMPORTED_MODULE_0___default()(InlineView.prototype);
/* harmony default export */ __webpack_exports__["a"] = (InlineView);
...
var rendition = __webpack_require__(28);

// EXTERNAL MODULE: external "JSZip"
var external_JSZip_ = __webpack_require__(68);
...
var localforage = __webpack_require__(41);
...
var conventions = __webpack_require__(23);
...
var isCallable = __webpack_require__(10);
var isPrototypeOf = __webpack_require__(96);
...
var IS_PURE = __webpack_require__(103);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(global) {/* harmony import */ var _book__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(42);
/* harmony import */ var _rendition__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(28);
/* harmony import */ var _epubcfi__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(2);
/* harmony import */ var _contents__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(15);
...
/* harmony import */ var _managers_views_inline__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(38);
/* harmony import */ var _managers_views_iframe__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(37);
/* harmony import */ var _managers_default__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(17);
/* harmony import */ var _managers_continuous__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(40);
...
var isValue         = __webpack_require__(43)
  , isPlainFunction = __webpack_require__(71)
  , assign          = __webpack_require__(75)
  , normalizeOpts   = __webpack_require__(83)
  , contains        = __webpack_require__(84);
...
module.exports = __webpack_require__(76)() ? Object.assign : __webpack_require__(77);
...
module.exports = __webpack_require__(85)() ? String.prototype.contains : __webpack_require__(86);
...
var sax = __webpack_require__(90);
...
var freeze = __webpack_require__(23).freeze;
...
var NAMESPACE = __webpack_require__(23).NAMESPACE;
...
var isForced = __webpack_require__(117);
...
var isObject = __webpack_require__(19);
var isSymbol = __webpack_require__(51);
var getMethod = __webpack_require__(99);
var ordinaryToPrimitive = __webpack_require__(102);
...
var aCallable = __webpack_require__(100);
...
var global = __webpack_require__(4);
var isCallable = __webpack_require__(10);
var tryToString = __webpack_require__(101);
...
var anObject = __webpack_require__(26);
var definePropertiesModule = __webpack_require__(120);
var enumBugKeys = __webpack_require__(35);
var hiddenKeys = __webpack_require__(34);
...
var trimmedEndIndex = __webpack_require__(129);
